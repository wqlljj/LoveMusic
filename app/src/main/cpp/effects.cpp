...
int FMOD_Main_effects()
{
    ...
    */
    ...
    ERRCHECK(result);
//    result = system->createSound(Common_MediaPath("wave.mp3"), FMOD_DEFAULT, 0, &sound);
//    result = system->createSound("/storage/emulated/0/kgmusic/wave.mp3", FMOD_DEFAULT, 0, &sound);
